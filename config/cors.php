...
return [
    ...
    'allowed_origins' => ['http://34.55.61.47:81', 'http://localhost:5173', 'http://localhost:5174', 'http://localhost:5175', 'http://34.55.61.47:83'], // Solo estos orígenes pueden acceder a la API
