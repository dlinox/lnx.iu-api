...
class CurriculumModuleUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'order' => 'required|integer|unique:curriculum_modules,order,' . $id . ',id,curriculum_id,' . $curriculumId,
            'area_id' => 'required',
            'module_id' => 'nullable|unique:curriculum_modules,module_id,' . $id . ',id,curriculum_id,' . $curriculumId,
