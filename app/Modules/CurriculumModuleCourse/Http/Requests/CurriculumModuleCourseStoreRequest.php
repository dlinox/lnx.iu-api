...
class CurriculumModuleCourseStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'order' => 'required|integer|unique:curriculum_module_courses,order,NULL,id,curriculum_module_id,' . $curriculumModuleId,
            'code' => 'nullable|string|max:50',
            'hours_practice' => 'required|integer',
            'hours_theory' => 'required|integer',
            'credits' => 'required|integer',
            'curriculum_module_id' => 'required',
            'course_id' => 'required|unique:curriculum_module_courses,course_id,NULL,id,curriculum_module_id,' . $curriculumModuleId,
