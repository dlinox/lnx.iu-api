...
class CurriculumCourseUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'order' => 'required|integer|unique:curriculum_courses,order,' . $id . ',id,curriculum_id,' . $curriculumId . ',module_id,' . $moduleId,
            'code' => 'nullable|string|max:50',
            'hours_practice' => 'required|integer',
            'hours_theory' => 'required|integer',
            'credits' => 'required|integer',
            'course_id' => 'required|unique:curriculum_courses,course_id,' . $id . ',id,curriculum_id,' . $curriculumId . ',module_id,' . $moduleId,
            'module_id' => 'nullable',
            'area_id' => 'required',
    ...
    public function messages()
    {
        return [
            ...
            'course_id.unique' => 'El curso ya existe en este módulo',
