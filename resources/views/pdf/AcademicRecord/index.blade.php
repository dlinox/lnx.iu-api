...
<table class="table-heading">
    <tr>
        <td colspan="2"><strong>ACTA DE EXAMEN:</strong> REGULAR</td>
        <td colspan="1" rowspan="3" style="text-align: right;">
            @if ($code)
            <table style="border-collapse: collapse; border: 1px solid #000; width: 150px;">
                <tr>
                    <td style="text-align: center; font-size: 14px; border: 1px solid #000;">
                        <p>CODIGO DE ACTA</p>
                    </td>
                </tr>
                <tr>
    ...
    <tr>
        <td colspan="2"><strong>CORRESPONDIENTE AL MES DE:</strong> {{ strtoupper($group->month) }}</td>
    </tr>
    <tr>
        <td colspan="2"><strong>CURSO:</strong> {{$group->course}}</td>
    </tr>
    <tr>
